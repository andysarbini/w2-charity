...
@section('title', 'Terima kasih Donatur')
...
@section('content')
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <h5 class="text-center">Terima Kasih Donatur</h5>
                ...
                <div class="row justify-content-between mt-3 mt-lg-4">
                    <div class="col-lg-3 col-md-4 text-center">
                        ...
                        <p class="mt-3 text-muted">0009092983299880</p>
                    </div>
                    <div class="col-lg-3 col-md-4 text-center">
                ...
                <p class="text-center mt-3 mt-lg-4">
                    Harap transfer sesuai dengan nominal "<strong>TOTAL TAGIHAN</strong>" ke bank yang tertera di atas! Setelah transfer lakukan konfirmasi! perbedaan nilai transfer akan menghambat proses verifikasi.
                </p>
                ...
                <div class="informasi d-flex justify-content-center align-items-center mt-3 mt-lg-4">
                    ...
                    <div class="bg-white rounded-right info text-center w-100 p-4 h-100">
                        <p>Kami sudah membuatkan akun W2Charity untuk anda, silahkan cek email anda.</p>
                        <strong>(example@charity.comn)</strong>
                    </div>
                </div>
            </div>
        </div>
