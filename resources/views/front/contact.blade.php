                ...
                <div class="col-lg-12">
                    <form action="{{ url('/contact') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            @enderror" placeholder="Masukkan No. Telepon" value="{{ old('phone') }}">
                            @error('phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    @enderror" placeholder="Masukkan Email" value="{{ old('email') }}">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    @enderror" placeholder="Masukkan Subjek" value="{{ old('subject') }}">
                                    @error('subject')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @enderror" cols="5" rows="10">{{ old('message') }}</textarea>
                            @error('message')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
