<div class="form-group">
    ...
    {{-- @dd($campaign->category_campaign->pluck('id')->toArray()) --}}
...
<div class="form-group">
    ...
    <input type="text" name="title" class="form-control" placeholder="Contoh: bantu Kafi melawan kanker" value="{{ isset($campaign) ? $campaign->title : '' }}">
  </div>
<div class="form-group">
